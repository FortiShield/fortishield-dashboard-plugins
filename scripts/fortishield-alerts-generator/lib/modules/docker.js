/*
 * Fortishield app - Docker sample data
...
module.exports.actorAttributesImage = ["fortishield/fortishield:3.12.0-7.6.1", "docker.elastic.co/elasticsearch/elasticsearch:7.6.2", "docker.elastic.co/kibana/kibana:7.6.2", "nginx:latest"];
...
module.exports.dataDocker = [{
  ...
  },
  {
    rule: {
      level: 3,
      description: "Docker: Image or repository fortishield/fortishield pulled",
      id: "87932",
      firedtimes: 1,
      mail: false,
      groups: ["docker"],
    ...
    data: {
      ...
      docker: {
        status: "pull",
        id: "fortishield/fortishield:3.9.2_7.1.1",
        Type: "image",
        Action: "pull",
        Actor: {
          ID: "fortishield/fortishield:3.9.2_7.1.1",
          Attributes: {
            name: "fortishield/fortishield"
          }
        },
        scope: "local",
        time: "1563354346",
  ...
  },
  {
    rule: {
      level: 3,
      description: "Docker: Image or repository fortishield/fortishield-elasticsearch pulled",
      id: "87932",
      firedtimes: 2,
      mail: false,
      groups: ["docker"],
    ...
    data: {
      ...
      docker: {
        status: "pull",
        id: "fortishield/fortishield-elasticsearch:3.9.2_7.1.1",
        Type: "image",
        Action: "pull",
        Actor: {
          ID: "fortishield/fortishield-elasticsearch:3.9.2_7.1.1",
          Attributes: {
            ...
            name: "fortishield/fortishield-elasticsearch",
            org: {
              "label-schema": {
                "build-date": "20190305",
                license: "GPLv2",
  ...
  },
  {
    rule: {
      level: 3,
      description: "Docker: Image or repository fortishield/fortishield-kibana pulled",
      id: "87932",
      firedtimes: 3,
      mail: false,
      groups: ["docker"],
    ...
    data: {
      ...
      docker: {
        status: "pull",
        id: "fortishield/fortishield-kibana:3.9.2_7.1.1",
        Type: "image",
        Action: "pull",
        Actor: {
          ID: "fortishield/fortishield-kibana:3.9.2_7.1.1",
          Attributes: {
            license: "Elastic License",
            name: "fortishield/fortishield-kibana",
            org: {
              "label-schema": {
                "build-date": "20190305",
                license: "GPLv2",
  ...
  },
  {
    rule: {
      level: 3,
      description: "Docker: Image or repository fortishield/fortishield-nginx pulled",
      id: "87932",
      firedtimes: 3,
      mail: false,
      groups: ["docker"],
    ...
    data: {
      ...
      docker: {
        status: "pull",
        id: "fortishield/fortishield-nginx:3.9.2_7.1.1",
        Type: "image",
        Action: "pull",
        Actor: {
          ID: "fortishield/fortishield-nginx:3.9.2_7.1.1",
          Attributes: {
            maintainer: "NGINX Docker Maintainers <docker-maint@nginx.com>",
            name: "fortishield/fortishield-nginx"
          }
        }
      },
      scope: "local",
