(function () {
  ...
  const cliName = 'Fortishield alerts generator';
  const cliDescription = 'Generates sample data of Fortishield alerts';
...
- Generate alerts for all the modules in OpenSearch/Elasticsearch Bulk API format to a fortishield-alerts index and save to a output.ndjson file
node ${cliFilePath} --all-modules --format bulk-api --index fortishield-alerts > output.ndjson
