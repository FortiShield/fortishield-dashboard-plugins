...
import {
  getFortishieldCheckUpdatesServices,
  getFortishieldCore,
...
const mockedGetFortishieldCore = getFortishieldCore as jest.Mock;
const mockedGetFortishieldCheckUpdatesServices =
  getFortishieldCheckUpdatesServices as jest.Mock;
...
describe('getUpdates function', () => {
  ...
  test('should return available updates from saved object', async () => {
    ...
    mockedGetFortishieldCore.mockImplementation(() => ({
      serverAPIHostEntries: {
        getHostsEntries: jest.fn(() => []),
      },
    }));

    mockedGetFortishieldCheckUpdatesServices.mockImplementation(() => ({
      logger: {
        debug: jest.fn(),
        info: jest.fn(),
        warn: jest.fn(),
  ...
  test('should return available updates from api', async () => {
    ...
    mockedGetFortishieldCore.mockImplementation(() => ({
      controllers: {
        FortishieldHostsCtrl: jest.fn().mockImplementation(() => ({
