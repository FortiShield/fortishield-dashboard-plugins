...
import { getCore, getFortishieldCore } from '../plugin-services';
import { AvailableUpdates } from '../../../fortishield-check-updates/common/types';
...
export const UpdatesNotification = () => {
  ...
  const sideNavDocked = getFortishieldCore().hooks.useDockedSideNav();
          ...
          <EuiFlexItem grow={false}>
            <EuiFlexGroup gutterSize='m' alignItems='center'>
              <EuiFlexItem grow={false} style={{ maxWidth: 'max-content' }}>
                <EuiText>
                  <FormattedMessage
                    id='fortishieldCheckUpdates.updatesNotification.message'
              ...
              <EuiFlexItem grow={false} style={{ maxWidth: 'max-content' }}>
                <RedirectAppLinks application={getCore().application}>
                  ...
                  >
                    <FormattedMessage
                      id='fortishieldCheckUpdates.updatesNotification.linkText'
            ...
            <EuiFlexGroup gutterSize='m' alignItems='center'>
              <EuiFlexItem grow={false}>
                <EuiCheckbox
                  ...
                  label={
                    <FormattedMessage
                      id='fortishieldCheckUpdates.updatesNotification.dismissCheckText'
              ...
              <EuiFlexItem grow={false} style={{ maxWidth: 'max-content' }}>
                ...
                >
                  <FormattedMessage
                    id='fortishieldCheckUpdates.updatesNotification.closeButtonText'
