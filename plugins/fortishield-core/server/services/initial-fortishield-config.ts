...
# Find more information about this on the LICENSE file.
#
${printSection('Fortishield app configuration file', { prefix: '# ', fill: '=' })}
#
# Please check the documentation for more information about configuration options:
# ${webDocumentationLink('user-manual/fortishield-dashboard/config-file.html')}
#
# Also, you can check our repository:
# https://github.com/fortishield/fortishield-kibana-app`;
...
export const hostsConfiguration = `${printSection('Fortishield hosts', { prefix: '# ', fill: '-' })}
#
...
#       # Use RBAC or not. If set to true, the username must be "fortishield-wui".
#       run_as: true
#   - env-2:
...
export const initialFortishieldConfig: string = [header, pluginSettingsConfiguration, hostsConfiguration].join('\n#\n');
