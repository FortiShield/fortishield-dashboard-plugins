// To launch this file
// yarn test:jest --testEnvironment node --verbose server/routes/fortishield-elastic
...
describe.skip('Fortishield Elastic', () => {
  describe('Fortishield API - /elastic/security/current-platform', () => {
  ...
  // describe('Fortishield API - /elastic/visualizations/{tab}/{pattern}', () => {
  ...
  describe('Fortishield API - /elastic/template/{pattern}', () => {
    test('[200] Check if there is some template with the pattern', () => {
      const options = buildAxiosOptions('get', '/elastic/template/fortishield-alerts-*');
      return axios(options).then((response) => {
        expect(response.status).toBe(200);
  ...
  // TODO: This test need to be defined
  // describe('Fortishield API - /elastic/top/{mode}/{cluster}/{field}/{pattern}', () => {
  ...
  describe('Fortishield API - /elastic/samplealerts', () => {
  ...
  describe('Fortishield API - /elastic/samplealerts/{category}', () => {
  ...
  // TODO: This test need to be defined
  // describe('Fortishield API - /elastic/alerts', () => {
  //   test('[200] Check if there an sample data index of Security category', () => {
  ...
  describe('Fortishield API - /elastic/statistics', () => {
    test('[200] Check if there an sample data index of Security category', () => {
