// To launch this file
// yarn test:jest --testEnvironment node --verbose server/routes/fortishield-api
...
describe.skip('Fortishield API', () => {
  describe('Fortishield API - /api/login', () => {
  ...
  describe('Fortishield API - /api/check-api', () => {
      ...
      return axios(options).catch(error => {
        ...
        expect(
          error.response.data.message.includes(
            'Selected API is no longer available in fortishield.yml',
          ),
        ).toBe(true);
      });
    });
  ...
  describe('Fortishield API - /api/check-stored-api', () => {
    test('[200] Check default api returns manager, node, cluster, status and allow_run_as params', () => {
  ...
  describe('Fortishield API - /api/request', () => {
    let userToken = null;
    beforeAll(() => {
  ...
  describe('Fortishield API - /api/routes', () => {
  ...
  describe('Fortishield API - /api/setup', () => {
  ...
  describe('Fortishield API - /api/syscollector', () => {
