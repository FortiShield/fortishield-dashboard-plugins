// To launch this file
// yarn test:jest --testEnvironment node --verbose server/routes/fortishield-hosts
...
describe.skip('Fortishield Host', () => {
  describe('Fortishield API - /hosts/apis', () => {
  ...
  describe('Fortishield API - /hosts/update-hostname', () => {
...
// describe('Fortishield API - /hosts/remove-orphan-entries', () => {
