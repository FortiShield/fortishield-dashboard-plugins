/*
 * Fortishield app - Module for Fortishield reporting routes
 ...
 */
import { FortishieldReportingCtrl } from '../controllers';
import { IRouter } from 'opensearch_dashboards/server';
import { schema } from '@osd/config-schema';

export function FortishieldReportingRoutes(router: IRouter) {
  const ctrl = new FortishieldReportingCtrl();
