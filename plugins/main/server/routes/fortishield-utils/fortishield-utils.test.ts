// To run this file:
// yarn test:jest --testEnvironment node --verbose server/routes/fortishield-utils
...
import { FortishieldUtilsRoutes } from './fortishield-utils';
import { FortishieldUtilsCtrl } from '../../controllers/fortishield-utils/fortishield-utils';
import {
...
beforeAll(async () => {
  ...
  const spyRouteDecoratorProtectedAdministratorRoleValidToken = jest
    .spyOn(
      FortishieldUtilsCtrl.prototype as any,
...
`;
  ...
  it.each`
    ...
    ${'fortishield.monitoring.creation'}      | ${'h'}                                                           | ${200}             | ${null}
    ${'fortishield.monitoring.creation'}      | ${'d'}                                                           | ${200}             | ${null}
    ${'fortishield.monitoring.creation'}      | ${'w'}                                                           | ${200}             | ${null}
    ${'fortishield.monitoring.creation'}      | ${'m'}                                                           | ${200}             | ${null}
    ${'fortishield.monitoring.creation'}      | ${'test'}                                                        | ${400}             | ${'[request body.fortishield.monitoring.creation]: types that failed validation:\n- [request body.fortishield.monitoring.creation.0]: expected value to equal [h]\n- [request body.fortishield.monitoring.creation.1]: expected value to equal [d]\n- [request body.fortishield.monitoring.creation.2]: expected value to equal [w]\n- [request body.fortishield.monitoring.creation.3]: expected value to equal [m]'}
    ${'fortishield.monitoring.enabled'}       | ${true}                                                          | ${200}             | ${null}
    ${'fortishield.monitoring.enabled'}       | ${0}                                                             | ${400}             | ${'[request body.fortishield.monitoring.enabled]: expected value of type [boolean] but got [number]'}
    ${'fortishield.monitoring.frequency'}     | ${100}                                                           | ${200}             | ${null}
    ${'fortishield.monitoring.frequency'}     | ${40}                                                            | ${400}             | ${'[request body.fortishield.monitoring.frequency]: Value should be greater or equal than 60.'}
    ${'fortishield.monitoring.frequency'}     | ${1.2}                                                           | ${400}             | ${'[request body.fortishield.monitoring.frequency]: Number should be an integer.'}
    ${'fortishield.monitoring.frequency'}     | ${''}                                                            | ${400}             | ${'[request body.fortishield.monitoring.frequency]: expected value of type [number] but got [string]'}
    ${'fortishield.monitoring.pattern'}       | ${'test'}                                                        | ${200}             | ${null}
    ${'fortishield.monitoring.pattern'}       | ${'test*'}                                                       | ${200}             | ${null}
    ${'fortishield.monitoring.pattern'}       | ${''}                                                            | ${400}             | ${'[request body.fortishield.monitoring.pattern]: value has length [0] but it must have a minimum length of [1].'}
    ${'fortishield.monitoring.pattern'}       | ${true}                                                          | ${400}             | ${'[request body.fortishield.monitoring.pattern]: expected value of type [string] but got [boolean]'}
    ${'fortishield.monitoring.pattern'}       | ${'-test'}                                                       | ${400}             | ${"[request body.fortishield.monitoring.pattern]: It can't start with: -, _, +, .."}
    ${'fortishield.monitoring.pattern'}       | ${'_test'}                                                       | ${400}             | ${"[request body.fortishield.monitoring.pattern]: It can't start with: -, _, +, .."}
    ${'fortishield.monitoring.pattern'}       | ${'+test'}                                                       | ${400}             | ${"[request body.fortishield.monitoring.pattern]: It can't start with: -, _, +, .."}
    ${'fortishield.monitoring.pattern'}       | ${'.test'}                                                       | ${400}             | ${"[request body.fortishield.monitoring.pattern]: It can't start with: -, _, +, .."}
    ${'fortishield.monitoring.pattern'}       | ${'test\\'}                                                      | ${400}             | ${'[request body.fortishield.monitoring.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'fortishield.monitoring.pattern'}       | ${'test/'}                                                       | ${400}             | ${'[request body.fortishield.monitoring.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'fortishield.monitoring.pattern'}       | ${'test?'}                                                       | ${400}             | ${'[request body.fortishield.monitoring.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'fortishield.monitoring.pattern'}       | ${'test"'}                                                       | ${400}             | ${'[request body.fortishield.monitoring.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'fortishield.monitoring.pattern'}       | ${'test<'}                                                       | ${400}             | ${'[request body.fortishield.monitoring.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ...
    ${'fortishield.monitoring.pattern'}       | ${'test,'}                                                       | ${400}             | ${'[request body.fortishield.monitoring.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'fortishield.monitoring.pattern'}       | ${'test#'}                                                       | ${400}             | ${'[request body.fortishield.monitoring.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'fortishield.monitoring.replicas'}      | ${0}                                                             | ${200}             | ${null}
    ${'fortishield.monitoring.replicas'}      | ${-1}                                                            | ${400}             | ${'[request body.fortishield.monitoring.replicas]: Value should be greater or equal than 0.'}
    ${'fortishield.monitoring.replicas'}      | ${1.2}                                                           | ${400}             | ${'[request body.fortishield.monitoring.replicas]: Number should be an integer.'}
    ${'fortishield.monitoring.replicas'}      | ${'custom'}                                                      | ${400}             | ${'[request body.fortishield.monitoring.replicas]: expected value of type [number] but got [string]'}
    ${'fortishield.monitoring.shards'}        | ${1}                                                             | ${200}             | ${null}
    ${'fortishield.monitoring.shards'}        | ${-1}                                                            | ${400}             | ${'[request body.fortishield.monitoring.shards]: Value should be greater or equal than 1.'}
    ${'fortishield.monitoring.shards'}        | ${1.2}                                                           | ${400}             | ${'[request body.fortishield.monitoring.shards]: Number should be an integer.'}
    ${'fortishield.monitoring.shards'}        | ${'custom'}                                                      | ${400}             | ${'[request body.fortishield.monitoring.shards]: expected value of type [number] but got [string]'}
  `(
