/*
 * Fortishield app - Module for Fortishield utils routes
 ...
 */
import { FortishieldUtilsCtrl } from '../../controllers';
...
export function FortishieldUtilsRoutes(router: IRouter) {
  const ctrl = new FortishieldUtilsCtrl();
