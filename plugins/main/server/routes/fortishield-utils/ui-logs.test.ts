// To launch this file
// yarn test:jest --testEnvironment node --verbose server/routes/fortishield-utils/ui-logs
...
describe.skip('Fortishield UI Logs', () => {
  describe('Fortishield API - /utils/logs/ui', () => {
    it('[200] Get UI Logs', () => {
