/*
 * Fortishield app - AWS sample data
...
export const apiCall = {
  "data": {
    "aws": {
      ...
      "log_info": {
        "s3bucket": "fortishield-aws-wodle",
...
export const iamPolicyGrantGlobal = {
  "data": {
    "aws": {
      "severity": "CRITICAL",
      "actor": "resources.fortishield.sample.com",
      "summary": {
        ...
        "Bucket": "resources.fortishield.sample.com,",
        "Record Count": "1",
        "Event Count": "1",
