/*
 * Fortishield app - Module for Agents/PCI visualizations
...
export default [
  {
    _id: 'Fortishield-App-Agents-PCI-Groups',
    _source: {
  ...
  {
    _id: 'Fortishield-App-Agents-PCI-Rule',
    _source: {
      title: 'Top 5 rules',
      visState: JSON.stringify({
        title: 'Top 5 rules',
  ...
  {
    _id: 'Fortishield-App-Agents-PCI-Requirement',
    _source: {
  ...
  {
    _id: 'Fortishield-App-Agents-PCI-Rule-level-distribution',
    _source: {
  ...
  {
    _id: 'Fortishield-App-Agents-PCI-Requirements',
    _source: {
      title: 'Requirements',
      visState: JSON.stringify({
        title: 'Requirements',
  ...
  {
    _id: 'Fortishield-App-Agents-PCI-Last-alerts',
    _type: 'visualization',
    _source: {
      title: 'Last alerts',
      visState: JSON.stringify({
