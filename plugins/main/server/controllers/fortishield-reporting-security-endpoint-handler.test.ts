import md5 from 'md5';
import fs from 'fs';
import { FortishieldReportingCtrl } from './fortishield-reporting';
...
const endpointController = new FortishieldReportingCtrl();
...
describe('[security] Report endpoints guard related to a file. Parameter defines or builds the filename.', () => {
  ...
  it.each`
    ...
    ${'Execute endpoint handler'} | ${'admin'}     | ${'fortishield-module-overview-general-1234.pdf'}          | ${false}
    ${'Endpoint protected'}       | ${'admin'}     | ${'../fortishield-module-overview-general-1234.pdf'}       | ${true}
    ${'Endpoint protected'}       | ${'admin'}     | ${'fortishield-module-overview-../general-1234.pdf'}       | ${true}
    ${'Endpoint protected'}       | ${'admin'}     | ${'custom../fortishield-module-overview-general-1234.pdf'} | ${true}
    ${'Execute endpoint handler'} | ${'../../etc'} | ${'fortishield-module-agents-001-general-1234.pdf'}        | ${false}
    ${'Endpoint protected'}       | ${'../../etc'} | ${'../fortishield-module-agents-001-general-1234.pdf'}     | ${true}
    ${'Endpoint protected'}       | ${'../../etc'} | ${'fortishield-module-overview-../general-1234.pdf'}       | ${true}
    ${'Endpoint protected'}       | ${'../../etc'} | ${'custom../fortishield-module-overview-general-1234.pdf'} | ${true}
  `(
    `$testTitle
	username: $username
	filename: $filename
...
describe('[security] GET /reports/{name}', () => {
  it.each`
    ...
    ${'Get report'}         | ${'admin'}     | ${'fortishield-module-overview-1234.pdf'}    | ${true}
    ${'Endpoint protected'} | ${'admin'}     | ${'../fortishield-module-overview-1234.pdf'} | ${false}
    ${'Get report'}         | ${'../../etc'} | ${'fortishield-module-overview-1234.pdf'}    | ${true}
    ${'Endpoint protected'} | ${'../../etc'} | ${'../fortishield-module-overview-1234.pdf'} | ${false}
  `(
    ...
    async ({ username, moduleID, valid }) => {
      ...
      if (valid) {
        ...
        expect(response.body.message).toMatch(
          new RegExp(`Report fortishield-module-overview-${moduleID}`),
        );
      } else {
        expect(response.body.message).toBe('5040 - You shall not pass!');
      }
...
describe('[security] DELETE /reports/<filename>', () => {
  ...
  it.each`
    titleTest               | username       | filename                                     | valid
    ${'Delete report'}      | ${'admin'}     | ${'fortishield-module-overview-1234.pdf'}          | ${true}
    ${'Endpoint protected'} | ${'admin'}     | ${'../fortishield-module-overview-1234.pdf'}       | ${false}
    ${'Endpoint protected'} | ${'admin'}     | ${'custom../fortishield-module-overview-1234.pdf'} | ${false}
    ${'Delete report'}      | ${'../../etc'} | ${'fortishield-module-overview-1234.pdf'}          | ${true}
    ${'Endpoint protected'} | ${'../../etc'} | ${'../fortishield-module-overview-1234.pdf'}       | ${false}
    ${'Endpoint protected'} | ${'../../etc'} | ${'custom../fortishield-module-overview-1234.pdf'} | ${false}
  `(
