...
export class FortishieldUtilsCtrl {
  /**
   * Constructor
   * @param {*} server
   */
  ...
  /**
   * Returns the fortishield.yml file parsed
  ...
  /**
   * Returns the fortishield.yml file in raw
   * @param {Object} context
   * @param {Object} request
   * @param {Object} response
   * @returns {Object} Configuration File or ErrorResponse
    ...
    this.routeDecoratorProtectedAdministratorRoleValidToken(
      async (
        ...
        if (Object.keys(pluginSettingsConfigurableFile).length) {
          ...
          await context.fortishield_core.updateConfigurationFile.updateConfiguration(
