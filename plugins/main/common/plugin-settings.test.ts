...
describe('[settings] Input validation', () => {
  it.each`
    ...
    ${'timeout'}                        | ${1.2}                                                                 | ${'Number should be an integer.'}
    ${'fortishield.monitoring.creation'}      | ${'h'}                                                                 | ${undefined}
    ${'fortishield.monitoring.creation'}      | ${'d'}                                                                 | ${undefined}
    ${'fortishield.monitoring.creation'}      | ${'w'}                                                                 | ${undefined}
    ${'fortishield.monitoring.creation'}      | ${'m'}                                                                 | ${undefined}
    ${'fortishield.monitoring.creation'}      | ${'test'}                                                              | ${'Invalid value. Allowed values: h, d, w, m.'}
    ${'fortishield.monitoring.enabled'}       | ${true}                                                                | ${undefined}
    ${'fortishield.monitoring.frequency'}     | ${100}                                                                 | ${undefined}
    ${'fortishield.monitoring.frequency'}     | ${40}                                                                  | ${'Value should be greater or equal than 60.'}
    ${'fortishield.monitoring.frequency'}     | ${'1.2'}                                                               | ${'Number should be an integer.'}
    ${'fortishield.monitoring.frequency'}     | ${1.2}                                                                 | ${'Number should be an integer.'}
    ${'fortishield.monitoring.pattern'}       | ${'test'}                                                              | ${undefined}
    ${'fortishield.monitoring.pattern'}       | ${'test*'}                                                             | ${undefined}
    ${'fortishield.monitoring.pattern'}       | ${''}                                                                  | ${'Value can not be empty.'}
    ${'fortishield.monitoring.pattern'}       | ${'-test'}                                                             | ${"It can't start with: -, _, +, .."}
    ${'fortishield.monitoring.pattern'}       | ${'_test'}                                                             | ${"It can't start with: -, _, +, .."}
    ${'fortishield.monitoring.pattern'}       | ${'+test'}                                                             | ${"It can't start with: -, _, +, .."}
    ${'fortishield.monitoring.pattern'}       | ${'.test'}                                                             | ${"It can't start with: -, _, +, .."}
    ${'fortishield.monitoring.pattern'}       | ${'test\\'}                                                            | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'fortishield.monitoring.pattern'}       | ${'test/'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'fortishield.monitoring.pattern'}       | ${'test?'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'fortishield.monitoring.pattern'}       | ${'test"'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'fortishield.monitoring.pattern'}       | ${'test<'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ...
    ${'fortishield.monitoring.pattern'}       | ${'test,'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'fortishield.monitoring.pattern'}       | ${'test#'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'fortishield.monitoring.replicas'}      | ${0}                                                                   | ${undefined}
    ${'fortishield.monitoring.replicas'}      | ${-1}                                                                  | ${'Value should be greater or equal than 0.'}
    ${'fortishield.monitoring.replicas'}      | ${'1.2'}                                                               | ${'Number should be an integer.'}
    ${'fortishield.monitoring.replicas'}      | ${1.2}                                                                 | ${'Number should be an integer.'}
    ${'fortishield.monitoring.shards'}        | ${1}                                                                   | ${undefined}
    ${'fortishield.monitoring.shards'}        | ${-1}                                                                  | ${'Value should be greater or equal than 1.'}
    ${'fortishield.monitoring.shards'}        | ${'1.2'}                                                               | ${'Number should be an integer.'}
    ${'fortishield.monitoring.shards'}        | ${1.2}                                                                 | ${'Number should be an integer.'}
