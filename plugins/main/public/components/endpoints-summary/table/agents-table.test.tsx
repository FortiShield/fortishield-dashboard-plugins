...
const data = [
  {
    ...
    os_name: {
      os: {
        ...
        platform: 'amzn',
        uname:
          'Linux |fortishield-manager-master-0 |4.14.114-105.126.amzn2.x86_64 |#1 SMP Tue May 7 02:26:40 UTC 2019 |x86_64',
        version: '2',
      },
      ip: '127.0.0.1',
      id: '001',
      ...
      name: 'Debian agent',
      status: 'active',
      manager: 'fortishield-manager-master-0',
      node_name: 'master',
      lastKeepAlive: '9999-12-31T23:59:59Z',
      version: 'Fortishield v4.5.0',
      group_config_status: 'not synced',
    },
    version: 'v4.5.0',
    node_name: 'master',
  ...
  {
    id: '002',
    name: 'fortishield-manager-master-0',
    ip: '127.0.0.1',
    status: 'active',
