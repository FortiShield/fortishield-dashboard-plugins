import { scapeSpecialCharsForLinux, scapeSpecialCharsForMacOS, scapeSpecialCharsForWindows } from './fortishield-password-service';
describe('Fortishield Password Service', () => {
  // NOTE:
