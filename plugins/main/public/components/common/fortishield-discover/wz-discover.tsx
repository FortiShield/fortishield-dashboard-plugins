...
type FortishieldDiscoverProps = {
  indexPatternName: string;
  tableColumns: tDataGridColumn[];
};

const FortishieldDiscoverComponent = (props: FortishieldDiscoverProps) => {
      ...
      >
        <>
          {isLoading ? (
            ...
            <SearchBar
              appName='fortishield-discover-search-bar'
              {...searchBarProps}
              showSaveQuery={true}
            />
          )}
...
export const FortishieldDiscover = withErrorBoundary(FortishieldDiscoverComponent);
