...
let urlBodys = [
  { alertCount: 27000, index: 'fortishield-alerts-4.x-sample-security' },
  { alertCount: 12000, index: 'fortishield-alerts-4.x-sample-auditing-policy-monitoring' },
  { alertCount: 15000, index: 'fortishield-alerts-4.x-sample-threat-detection' },
];
