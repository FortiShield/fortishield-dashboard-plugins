export const FORTISHIELD_MENU_PAGE = {
  fortishieldMenuLeft: '.wz-menu-left-side .wz-menu-sections',
  fortishieldMenuRight: '.wz-menu-right-side',
  fortishieldMenuSettingRight: '.wz-menu-right-side .WzManagementSideMenu',
  fortishieldMenuButton: '[data-test-subj=menuFortishieldButton]',
  //region Menu
  //region Menu
