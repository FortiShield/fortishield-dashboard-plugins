...
if [ ! -f $WITNESS_FILE_PATH ]; then
    ...
    sed -i "s:<name>fortishield</name>:<name>$CLUSTER_NAME</name>:g" /var/ossec/etc/ossec.conf
...
/var/ossec/bin/fortishield-apid restart
